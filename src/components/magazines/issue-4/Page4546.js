...
const Page4546 = () => (
  <div className={styles.wrapper}>
    ...
    <img className={styles.rect5} src='/magazine/4/images/4546_image6.png' />
    <img className={styles.rect6} src='/magazine/4/images/4546_image6.png' />
    ...
    <img className={styles.image9} src='/magazine/4/images/4546_image7.png' />
