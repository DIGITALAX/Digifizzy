...
const Page5960 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      ><img src={`./magazine/3/images/59_60/${play ? 'pause' : 'play'}.png`} className={styles.playbutton1} />
      </button>
