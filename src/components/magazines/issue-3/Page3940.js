...
const Page3940 = () => (
  <div className={styles.wrapper}>
    ...
    <p className={styles.text4}>DIGITALAX and the
      ...
      have partnered with top DeFi protocols creating hybrid digital-physical NFT fashion collections with DeFi functionality. Stake the NFTs for crypto yield.
    </p>
