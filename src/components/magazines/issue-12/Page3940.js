  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text1}>
        ...
        can and that to create something new and meaningful, I need to keep my ears always open for
        new stuff. for me, "the industry" is my way to get my music to as many ears as possible.
        <br />
        <br />I came across the idea of the NFTs at my friend's concert. My friends -"The Vibe
        Souls" had a beautiful show at "The Mynt" art Gallery, corporating with artist Gonzalo
        Gelso, who created live animation interacting live with their music. At this event, I was
        exposed first to the concept of NFTs. I met Emma Jane Mackinnon Lee, who was generous enough
        to share with me the idea of web 3.0 and how it can impact the way we make art. I was amazed
        by the new possibilities that come with this concept:
      </div>
      <div className={styles.text2}>
        Keeping the rights and the control in the artists' hands, being a good platform for artists
        from different disciplines to collaborate, helping artists to get their works into new
        people, and maybe the most interesting and exciting for me - helping artists to create
        communities.
        <br />
        <br />
        ...
        be our way to create communities of artists who have the same vision and wants to develop a
        ...
        idea in a concise piece. Creating these is different from making a seven-minute music piece
        that stands for itself. The other thing which I'm
      </div>
      <div className={styles.text3}>
        ...
        with a few people to create an NFT version of my new album, "Searching for Colors," which
        I'll release on April 25. I'm also looking forward to collaborating with contemporary
        artists and creating music to their visuals, which is a totally different work process.
        <br />
        <br />
