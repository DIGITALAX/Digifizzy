...
const Page5354 = () => (
  <div className={styles.wrapper}>
    ...
    <div className={styles.text1}>
      ...
      [“**But how does bitcoin actually work?”](https://youtube.com/watch?v=bBC-nXj3Ng4)** and
      everything I had been hearing about blockchain started to click.
      <br />
      <br />
      ...
      “[Genesis](https://foundation.app/@SuperTrip64/foundation/6557)” by Supertrip64 and I thought
      it would be really cool to own and display on VR. It was actually minted as an NFT, to my
      surprise, and bought by RTKFT, who I was unaware of at the time. The Metaverse was finally
      starting to make sense to me; the dream would be interoperable assets that you could show off,
      trade, and sell across the internet. I still could never justify spending a house on some
      JPEGs but I could finally understand why some would be interested in doing so.
      <br />
      <br />
      ...
      [Nouns](http://nouns.wtf) is a novel NFT project that auctions one Noun a day *forever.* All
      proceeds from the auctions go to a shared treasury governed by the DAO where each Noun = 1
      vote in the DAO. Because Nouns are super expensive (the first 100 Nouns sold for an average of
      over 100 ETH each), SharkDAO came along to raise ETH in order to collects Nouns as a
      community, grow the NounsDAO ecosystem, and partner with artists and developers to build some
      cool stuff like merch, twitter Noun personalities like
      [Bruce](https://twitter.com/bruce_noun), and an upcoming NFT project.
    </div>
    <div className={styles.text2}>
      ...
      patents? Do you notice a difference between scarcity and abundance mindsets? CC0 blew my mind
      the when I first saw it tweeted by self proclaimed “CC0 maxi,”
      [Nicholas](https://twitter.com/nnnnicholas). It made a lot of sense to me because why
      shouldn’t the projects built on top of open source protocols also be open source? Copyright
      freedom has since felt like the obvious conclusion to me. Contributing to a CC0 project like
      Nouns is super freeing as well. You never have to be worried about walking on eggshells or
      whether you’re in violation of a project or company’s license. Knowing that no one is going to
      slap you with a lawsuit really helps contributors and builders sleep at night too. I’ve seen
      some other projects in the space have the most obscure rules when it comes to licensing that
      it’s such a headache to even comprehend. Another downside to trying to protect your IP is that
      you’re going to be spending a lot of resources trying to combat copycat projects. There’s an
      opportunity cost to every decision and I’d much rather be spending time building rather than
      trying to cease and desist copcycats.
      <br />
      <br />
