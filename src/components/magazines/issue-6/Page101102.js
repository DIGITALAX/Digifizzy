...
const Page101102 = () => (
  <div className={styles.wrapper}>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/574/1/0/`} target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/575/1/0/`} target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/576/1/0/`} target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/577/1/0/`} target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/561/2/0/`} target='_blank' rel='noreferrer'>
      <img
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/564/1/0/`} target='_blank' rel='noreferrer'>
