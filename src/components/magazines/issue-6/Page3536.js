...
const Page3536 = () => (
  <div className={styles.wrapper}>
    ...
    <a href='https://www.hicetnunc.xyz/objkt/398848' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/3536_image1.png' className={styles.image1} />
    </a>
    <a href='https://superrare.com/artwork-v2/anonymous-digital-portrait-v002-28496' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/3536_image2.gif' className={styles.image2} />
    </a>
    <a href='https://superrare.com/artwork-v2/%E7%8E%84:-hakui-by-pass-29090' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/3536_image3.gif' className={styles.image3} />
    </a>

    <a href='https://superrare.com/artwork-v2/cyberloop-29128' target='_blank' rel='noreferrer'>
      <video autoPlay muted loop className={styles.video1}>
        <source src='./magazine/6/videos/3536_video1.mp4' type='video/mp4' />
      </video>
    </a>

    <a href='https://foundation.app/@kristenroos/~/54546' target='_blank' rel='noreferrer'>
