...
const Page103104 = () => (
  <div className={styles.wrapper}>
    ...
    <a href='https://poap.website/gdnpurveyors6' target='_blank' rel='noreferrer'>
      <img src='/images/poap-logo.png' className={styles.poapImage} />
    </a>

    <a href='https://twitter.com/JordanLzG' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/101102_image2.png' className={styles.image3} />
    </a>
    <a href='https://twitter.com/evabeylin' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/101102_image3.png' className={styles.image4} />
    </a>
    <a href='https://twitter.com/robnessofficial' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/101102_image4.png' className={styles.image5} />
    </a>
    <a href='https://twitter.com/coin_artist' target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/565/1/0/`} target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/566/1/0/`} target='_blank' rel='noreferrer'>
      <img
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/567/1/0/`} target='_blank' rel='noreferrer'>
      <img
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/568/1/0/`} target='_blank' rel='noreferrer'>
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/569/1/0/`} target='_blank' rel='noreferrer'>
      <img
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/570/1/0/`} target='_blank' rel='noreferrer'>
      <img
    ...
    <a href={`${DIGITALAX_FASHION_WEBSITE}/product/571/1/0/`} target='_blank' rel='noreferrer'>
