...
const Page4950 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <a href='https://twitter.com/0xjacobean' target='_blank' rel='noreferrer'>
        <img src='/magazine/6/images/49_50_image2.png' className={styles.link2} />
      </a>
      <a href='https://twitter.com/FeliramiArt' target='_blank' rel='noreferrer'>
      ...
      <div className={styles.text3}>
        ...
        <a href='https://discord.gg/fAGHysxKux' target='_blank' rel='noreferrer'>
          discord
        </a>{' '}
      ...
      <a href='https://twitter.com/Burb8873' target='_blank' rel='noreferrer'>
      ...
      <a href='https://twitter.com/Bens_Lab' target='_blank' rel='noreferrer'>
      ...
      <a href='https://twitter.com/letsglitchit' target='_blank' rel='noreferrer'>
      ...
      <a href='https://twitter.com/madkrahen' target='_blank' rel='noreferrer'>
      ...
      <a href='https://twitter.com/voidkross' target='_blank' rel='noreferrer'>
