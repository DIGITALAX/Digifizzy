...
const Page5152 = () => (
  <div className={styles.wrapper}>
    ...
    <a href='https://twitter.com/julietaVezes' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link1.png' className={styles.link1} />
    </a>
    <a href='https://twitter.com/ElijahNegasi' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link2.png' className={styles.link2} />
    </a>
    <a href='https://twitter.com/DeportedPhotog' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link3.png' className={styles.link3} />
    </a>
    <a href='https://twitter.com/TheGlitchedArts' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link4.png' className={styles.link4} />
    </a>
    <a href='https://twitter.com/jessytsuki' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link5.png' className={styles.link5} />
    </a>
    <a href='https://twitter.com/slimsuli' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link6.png' className={styles.link6} />
    </a>
    <a href='https://twitter.com/CityShrug' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_gif1.gif' className={styles.link7} />
    </a>
    <a href='https://twitter.com/___Philosopher_' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link7.png' className={styles.link8} />
    </a>
    <a href='https://twitter.com/vocesferales' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link8.png' className={styles.link9} />
    </a>
    <a href='https://twitter.com/kway_side' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link9.png' className={styles.link10} />
    </a>
    <a href='https://twitter.com/xwaveart' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_link10.png' className={styles.link11} />
    </a>
    <a href='https://twitter.com/x3r0ne' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_gif2.gif' className={styles.link12} />
    </a>
    <a href='https://twitter.com/GlitchXSpite' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_gif3.gif' className={styles.link13} />
    </a>
    <a href='https://twitter.com/wasem_simon' target='_blank' rel='noreferrer'>
      <img src='/magazine/6/images/51_52_gif4.gif' className={styles.link14} />
    </a>
    <a href='https://twitter.com/tbinkiewinkie' target='_blank' rel='noreferrer'>
