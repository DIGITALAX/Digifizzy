...
const Page6364 = () => (
  <div className={styles.wrapper}>
    ...
    <a href='https://somniumspace.com/parcel/2701' target='_blank' rel='noreferrer'>
      <img src='./magazine/2/images/63_64/image5.png' className={styles.image5} />
    </a>
    <a href='https://somniumspace.com/parcel/752' target='_blank' rel='noreferrer'>
      <img src='./magazine/2/images/63_64/image6.png' className={styles.image6} />
    </a>
    <a href='https://somniumspace.com/parcel/3250' target='_blank' rel='noreferrer'>
      <img src='./magazine/2/images/63_64/image7.png' className={styles.image7} />
    </a>
    <a href='https://somniumspace.com/parcel/3461' target='_blank' rel='noreferrer'>
