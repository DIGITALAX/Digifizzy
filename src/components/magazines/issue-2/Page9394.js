...
const Page9394 = () => (
  <div className={styles.wrapper}>
    ...
    <p className={styles.text14}>Our Competition winners included; <span className={styles.text15}>Porka_X, Blade Runway, Marcello Baldari, Tony Lukey, BBlundeRR and Mia Locklace.</span>
      <br /><br />
      Their FLARE creations were minted as NFTs on Matic Network and can be collected in the DIGIFIZZY Bundles as part of the #FLEXYOURFLARE Digital Fashion Collection.
    </p>
  </div>
)
