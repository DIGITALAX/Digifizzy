  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text1}>
        ...
        <br />
        Join their{' '}
        <a href='https://catalog.community/' target='_blank' rel='noreferrer'>
          discord
        </a>{' '}
      ...
      <a href='https://beta.catalog.works/aer/medina' target='_blank' className={styles.text4} rel='noreferrer'>
        {' '}
        Medina | Aer{' '}
      </a>
      <a
