...
const Page115116 = () => (
  <div className={styles.wrapper}>
    ...
    <p className={styles.text3}>Do virtual worlds need virtual handbags? How do our physical items translate into virtual spaces?
      <br /><br />
      Beginning with these questions and four fashion archetypes of the physical world, this capsule of three colorways brings together a bag, belt, a piece of jewelry, and a pair of sneakers into a digital hybrid accessory.
    </p>
    <p className={styles.text4}>Lauren is an American fashion designer and entrepreneur, starting out in 2012. She specialises in circular and digital fashion, in Paris, London, and New York.
      ...
      She is the founder of Alterrage, a phygital fashion brand bridging the digital realm with physical reality. Creating the future of phygital.
    </p>
