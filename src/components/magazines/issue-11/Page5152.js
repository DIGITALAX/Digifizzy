...
const Page5152 = () => {
  ...
  <div className={styles.wrapper}>
    ...
    <div className={styles.text10}>
      This space is amazing because I get the opportunity to interface and connect with people I would never get the change to IRL. We’re all equal in web3. You are your reputation and builders can develop a positive one fast.      
    </div>
