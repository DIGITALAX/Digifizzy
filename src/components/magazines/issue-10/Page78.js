...
const Page78 = () => (
  <div className={styles.wrapper}>
    ...
    <div className={styles.text4}>
      Much has been said about the decades-long corporate stranglehold in tech.
      <br /><br />
    ...
    <div className={styles.text5}>
      ...
      <br /><br />
      It’s not without its flaws, and the apprehension many creators feel as they make their way through web3 is palpable considering some of the experiences they’ve had with legacy fashion actors–the same ones worming their way into the good graces of this new market.
    </div>
