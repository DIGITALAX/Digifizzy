...
const Page8586 = () => (
  <div className={styles.wrapper}>
    ...
    <div className={styles.text3}>
      There was an unexpected moment when I ran into Bill Clinton. I was on my way back home from eating dinner with a friend. I then saw him about to go into his hotel… of course me being me I had to say hello! I took a pic with him (we were blinded by the flash on my phone lol!).
    </div>
    <div className={styles.text4}>
      I will never forget when I got to walk, in my first protest for the BLM movement in June 2020. This experience was so moving for me. My grandfather was a huge advocate for being an active citizen and pushing to get rights for black and brown communities. I’ve always wanted to follow his footsteps and fight for a good cause. 
    </div>
    <div className={styles.text5}>
      For me it is simple- more spaces for POC, LGBTQ+, and women! It’s expected for creatives to have this mind set, that there should be a safe space, for any and all identities. There needs to be an expansion of open spaces, for all job fields around the globe!
      <br /><br />
