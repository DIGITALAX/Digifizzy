  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.text5}>
        I've had the blessing of being brought up two different continents during the emergence of Hip Hop. I was born in Syracuse New York, but later grew up in Zimbabwe / South Africa. I've always wanted to know more than what was given or told. From a young age I always had a different way of processing information. 
        <br /><br />
      ...
      <div className={styles.text6}>
        I've always had an attraction to dance and creatively express. 
        <br /><br />
        Back in the early '90s when I would body paint myself gold and do performances in Parks, streets and even the Subway, I explored my ability to enter a trans like state. When I would finally decide to move, I would feel the energy transcending through my body. 
        <br /><br />
        This led me to an even deeper path of intuitive movement exploration. 
        <br /><br />
        I began to develop an animated creature-like aesthetic. Almost like I was a conductor of the energy moving through me. Then one day I thought I saw myself on channel 13 and I was beginning to wonder who had filmed me without my knowledge. 
        <br /><br />
        ...
        <br /><br />
        This also reminded me of how I moved also. It was then at that moment when I committed to travel to the East. After exploring different countries I began to focus on the Balinese dance style called the Baris. This also became the first time I decided to study a dance formally. 
        <br /><br />
        Before this, everything I had learned was self-taught. I use to throat singing inspired by Tuva. This is a technique where one makes more than one tone at the same time. This is also known as overtone and or harmonic singing. My method combines the sound with my movement and therefore emphasizes multi-dimensional interactions. I'm excited to explore the dimension of the multiverse, also known as the metaverse.        
      </div>
      <div className={styles.text7}>
        ...
        <br /><br />
        Artists need to shift how they generate income & learn how to build together. I'm hopeful that this is what can manifest within the web3 NFT community.
      </div>
