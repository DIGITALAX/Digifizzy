...
const Page7374 = () => (
  <div className={styles.wrapper}>
    <div className={styles.imageBackground}>
      <Image
        src='/magazine/7/images/7374_background.jpg'
        width={1920}
        height={1497}
      />
    </div>
    ...
    <div className={styles.text4}>
      BURN YOUR ERC-721 <span>THROUGH THE DIGIFIZZY.XYZ WEBSITE</span> TO UNLOCK A COLLECTION OF ERC-1155 NFTs + HIDDEN MAGAZINE CONTENT AND DYNAMIC NFT AIRDROPS. 3 x BUNDLES: COMMON, SEMI-RARE, EXCLUSIVE.
    </div>
    <div className={styles.text5}>
      Web3 wizards collectibles
    </div>
    <div className={styles.text6}>
      Physical REALMS AND PATRON drip
    </div>
    <div className={styles.text7}>
      BANCOR V3 DRIP PHYSICAL T-SHIRT
    </div>

    <div className={styles.image1}>
      <Image
        src='/magazine/7/images/7374_image1.jpg'
        width={836}
        height={209}
      />
    </div>
    ...
    <div className={styles.text8}>
      ENS CLAIM TICKET FOR DIGIFIZZY.ETH SUBDOMAIN
    </div>

    <div className={styles.image2}>
      <Image
        src='/magazine/7/images/7374_image2.jpg'
        width={283}
        height={279}
      />
    </div>
    ...
    <div className={styles.image3}>
      <Image
        src='/magazine/7/images/7374_image3.jpg'
        width={283}
        height={279}
      />
    </div>
    <div className={styles.image4}>
      <Image
        src='/magazine/7/images/7374_image4.jpg'
        width={303}
        height={303}
      />
    </div>
    <div className={styles.image5}>
      <Image
        src='/magazine/7/images/7374_image5.jpg'
        width={303}
        height={303}
      />
    </div>
