...
const Page6566 = () => (
  <div className={styles.wrapper}>
    ...
    <a href='https://gamebanana.com/mods/185093' className={styles.link1} target='_blank' rel='noreferrer'>
      SEE MODS
    </a>
    <a href='https://discord.gg/bzdVPUE8T4' className={styles.link2} target='_blank' rel='noreferrer'>
      PLAY HERE!
    </a>
    <div className={styles.rightBottomText}>
      Modded by{' '}
      <a href='https://www.nexusmods.com/brawlhalla/mods/27' target='_blank' rel='noreferrer'>
        Starmiinor.
      </a>{' '}
