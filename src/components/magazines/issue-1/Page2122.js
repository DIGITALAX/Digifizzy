...
const LoremText = (props) => {
  ...
  return (
    <div
      className={styles.loremTextWrapper}
      style={{
        left,
        top
      }}
...
const Page2122 = () => (
  <div className={styles.wrapper}>
    ...
    <a href='https://foundation.app/iartsometimes/improperly-processed-emotions-229' target='_blank' rel='noreferrer'>
      <img src='./magazine/1/images/21-01.jpg' className={styles.image1} />
    </a>
    <a href='https://rarible.com/token/0xd07dc4262bcdbf85190c01c996b4c06a461d2430:512984' target='_blank' rel='noreferrer'>
      <img src='./magazine/1/images/21-02.jpg' className={styles.image2} />
    </a>
    <a href='https://foundation.app/frickltd/chaos-19373' target='_blank' rel='noreferrer'>
      <img src='./magazine/1/images/21-03.jpg' className={styles.image3} />
    </a>
    <a href='https://foundation.app/IY/creative-block-6168' target='_blank' rel='noreferrer'>
      <img src='./magazine/1/images/21-04.jpg' className={styles.image4} />
    </a>
    <a href='https://superrare.co/artwork-v2/the-ethertales---acrophobia-19306' target='_blank' rel='noreferrer'>
      <img src='./magazine/1/images/21-05.jpg' className={styles.image5} />
    </a>
    <a href='https://superrare.co/artwork-v2/let-go-16947' target='_blank' rel='noreferrer'>
      <img src='./magazine/1/images/21-06.png' className={styles.image6} />
    </a>
    <a href='https://foundation.app/lorem/burst-two-1725' target='_blank' rel='noreferrer'>
      <video autoPlay muted loop className={styles.nftVideo2}>
        <source src='./magazine/1/videos/NFT2.mp4' type='video/mp4' />
      </video>
    </a>
    <a href='https://foundation.app/jeff.kraus/bom-dia-05-1442' target='_blank' rel='noreferrer'>
