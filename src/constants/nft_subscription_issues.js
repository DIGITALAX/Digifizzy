  ...
  [
    {
      ...
      subTitle: [
        'Issue Fourteen',
        'The Metaverse Workshop White Tee',
        'The Metaverse Workshop Wall Poster',
        'Stack Skills Navy Tee',
        'Stack Skills Wall Poster',
      ],
      ...
      body: [
        'DIGIFIZZY is the first of its kind. It’s architected for the metaverse, bringing together creators, anarchists, risk takers and dreamers across web3, fashion, gaming, art, music, crypto and NFTs, to prove out a completely new publishing distribution model. DIGIFIZZY is for the gatemakers. For the common unlockable ERC-998 bundle you can burn your 721 NFT to receive 1155 NFT treasures of unique digital and physical apparel + wall poster combinations!',
        'The Metaverse Workshops of today and tomorrow white tee.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'The Metaverse Workshop Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills navy tee. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
      ],
      price: 0.5,
      amountAvailable: 700,
    },
    {
      ...
      subTitle: [
        'Issue Fourteen',
        'The Metaverse Workshop Black Tee',
        'The Metaverse Workshop Wall Poster',
        'Impeach the Court White Hoodie',
        'Impeach the Court Wall Poster',
        'Stack Skills Navy Hoodie',
        'Stack Skills Wall Poster',
      ],
      issueIndex: 'Issue Fourteen',
      url: [
        '/images/nft/14/semi/semiover.mp4',
        '/images/nft/14/semi/Artboard Copy 2.png',
        '/images/nft/14/semi/Artboard Copy 3 2.png',
        '/images/nft/14/semi/Artboard Copy 4.png',
        '/images/nft/14/semi/Artboard Copy 3.png',
        '/images/nft/14/semi/Artboard Copy 5.png',
        '/images/nft/14/semi/Artboard Copy 2 2.png',
      ],
      body: [
        'DIGIFIZZY is the first of its kind. It’s architected for the metaverse, bringing together creators, anarchists, risk takers and dreamers across web3, fashion, gaming, art, music, crypto and NFTs, to prove out a completely new publishing distribution model. DIGIFIZZY is for the gatemakers. For the semi-rare unlockable ERC-998 bundle you can burn your 721 NFT to receive 1155 NFT treasures of unique digital and physical apparel + wall poster combinations!',
        'The Metaverse Workshops of today and tomorrow black tee.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'The Metaverse Workshop Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Impeach the Court white hoodie.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Impeach the Court Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills navy hoodie. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
      ],
      price: 1,
      amountAvailable: 200,
    },
    {
      ...
      subTitle: [
        'Issue Fourteen',
        'The Metaverse Workshop Navy Tee',
        'The Metaverse Workshop Wall Poster',
        'Impeach the Court White Tee',
        'Impeach the Court Wall Poster',
        'Stack Skills Navy Tee',
        'Stack Skills Navy Hoodie',
        'Stack Skills Wall Poster',
        'NFT from JPEGS to Use Black Tee',
        'NFT from JPEGS to Use Black Hoodie',
        'NFT from JPEGS to Use Wall Poster',
      ],
      issueIndex: 'Issue Fourteen',
      url: [
        '/images/nft/14/exc/excover.mp4',
        '/images/nft/14/exc/Artboard Copy 2 3.png',
        '/images/nft/14/exc/Artboard Copy 3 2.png',
        '/images/nft/14/exc/Artboard Copy 3 3.png',
        '/images/nft/14/exc/Artboard Copy 3.png',
        '/images/nft/14/exc/Artboard Copy 2 4.png',
        '/images/nft/14/exc/Artboard Copy 5.png',
        '/images/nft/14/exc/Artboard Copy 2 2.png',
        '/images/nft/14/exc/Artboard Copy 4 2.png',
        '/images/nft/14/exc/Artboard Copy 6.png',
        '/images/nft/14/exc/Artboard Copy 4 3.png',
      ],
      body: [
        'DIGIFIZZY is the first of its kind. It’s architected for the metaverse, bringing together creators, anarchists, risk takers and dreamers across web3, fashion, gaming, art, music, crypto and NFTs, to prove out a completely new publishing distribution model. DIGIFIZZY is for the gatemakers. For the exclusive unlockable ERC-998 bundle you can burn your 721 NFT to receive 1155 NFT treasures of unique digital and physical apparel + wall poster combinations!',
        'The Metaverse Workshops of today and tomorrow navy tee.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'The Metaverse Workshop Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Impeach the Court white tee.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Impeach the Court Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills navy tee. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills navy hoodie. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Stack Skills Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'NFT from JPEGS to Use black tee. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'NFT from JPEGS to Use black hoodie. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'NFT from JPEGS to Use Wall Poster. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
      ],
      price: 2,
      amountAvailable: 58,
    },
  ...
  [
    {
      ...
      subTitle: [
        'Issue Thirteen',
        'F3Manifesto Encrypted Trea[]ures Oversized Tee White',
        'F3Manifesto Sticker & Wheatpaste Pack',
        'HimeX Exclusive Digital Art',
        'NYC Streetwear Runway NFT',
      ],
      issueIndex: 'Issue Thirteen',
      url: [
        '/images/nft/13/common/1.mp4',
        '/images/nft/13/common/2.gif',
        '/images/nft/13/common/3.mp4',
        '/images/nft/13/common/4.png',
        '/images/nft/13/common/5.gif',
      ],
      body: [
        'DIGIFIZZY is the first of its kind. It’s architected for the metaverse, bringing together creators, anarchists, risk takers and dreamers across web3, fashion, gaming, art, music, crypto and NFTs, to prove out a completely new publishing distribution model. DIGIFIZZY is for the gatemakers. For the common unlockable ERC-998 bundle you can burn your 721 NFT to receive 1155 NFT treasures; F3Manifesto CC0 Encrypted Trea[]ures Oversized Tee, F3Manifesto Sticker and Wheatpaste Packs, HimeX Exclusive Digital Art and Shuffled NYC Streetwear Runway NFTs.',
        'Encrypted Trea[]ures Oversized Tee by F3Manifesto.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'One Wheatpaste Poster & Half Slap Kit. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Exclusive digital art piece from the HimeX realm.',
        'A surprise NYC Streetwear runway NFT. Stake the 721 NFT for $MONA yield.',
      ],
      price: 0.5,
      amountAvailable: 700,
    },
    {
      ...
      subTitle: [
        ...
        'F3Manifesto Encrypted Trea[]ures Oversized Tee White',
        'F3Manifesto Sticker & Wheatpaste Pack',
        'F3Manifesto Encrypted Trea[]ures Oversized Tee Violet',
        'NYC Streetwear Runway NFT',
      ],
      issueIndex: 'Issue Thirteen',
      url: [
        '/images/nft/13/semi/1.mp4',
        '/images/nft/13/common/4.png',
        '/images/nft/13/common/2.gif',
        '/images/nft/13/semi/4.mp4',
        '/images/nft/13/semi/5.gif',
        '/images/nft/13/common/5.gif',
      ],
      body: [
        'DIGIFIZZY is the first of its kind. It’s architected for the metaverse, bringing together creators, anarchists, risk takers and dreamers across web3, fashion, gaming, art, music, crypto and NFTs, to prove out a completely new publishing distribution model. DIGIFIZZY is for the gatemakers.For the semi-rare unlockable ERC-998 bundle you can burn your 721 NFT to receive 1155 NFT treasures; F3Manifesto CC0 Encrypted Trea[]ures Oversized Tee, F3Manifesto Sticker and Wheatpaste Packs, HimeX Exclusive Digital Art and Shuffled NYC Streetwear Runway NFTs.',
        'Exclusive digital art piece from the HimeX realm.',
        'Encrypted Trea[]ures Oversized Tee by F3Manifesto.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order. ',
        'Two Wheatpaste Posters & Half Slap Kit. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Encrypted Trea[]ures Oversized Tee by F3Manifesto.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'A surprise NYC Streetwear runway NFT. Stake the 721 NFT for $MONA yield.',
      ],
      price: 1,
    ...
    },
    {
      ...
      subTitle: [
        ...
        'F3Manifesto Encrypted Trea[]ures Oversized Tee White',
        'F3Manifesto Encrypted Trea[]ures Oversized Tee Violet',
        'F3Manifesto Encrypted Trea[]ures Oversized Tee Purple',
        'F3Manifesto Sticker & Wheatpaste Pack',
        'HimeX Exclusive Digital Art',
        'NYC Streetwear Runway NFT',
      ...
      issueIndex: 'Issue Thirteen',
      url: [
        '/images/nft/13/exc/1.mp4',
        '/images/nft/13/common/2.gif',
        '/images/nft/13/semi/5.gif',
        '/images/nft/13/exc/4.gif',
        '/images/nft/13/exc/5.mp4',
        '/images/nft/13/common/4.png',
        '/images/nft/13/common/5.gif',
        '/images/nft/13/exc/8.png',
        '/images/nft/13/exc/9.png',
        '/images/nft/13/exc/10.png',
        '/images/nft/13/exc/11.png',
      ],
      body: [
        'DIGIFIZZY is the first of its kind. It’s architected for the metaverse, bringing together creators, anarchists, risk takers and dreamers across web3, fashion, gaming, art, music, crypto and NFTs, to prove out a completely new publishing distribution model. DIGIFIZZY is for the gatemakers. For the exclusive unlockable ERC-998 bundle you can burn your 721 NFT to receive 1155 NFT treasures; F3Manifesto CC0 Encrypted Trea[]ures Oversized Tee, F3Manifesto Sticker and Wheatpaste Packs, HimeX Exclusive Digital Art, Shuffled NYC Streetwear Runway NFTs and Web3 Wizards collectible series.',
        'Encrypted Trea[]ures Oversized Tee by F3Manifesto.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Encrypted Trea[]ures Oversized Tee by F3Manifesto.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Encrypted Trea[]ures Oversized Tee by F3Manifesto.  Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Four Wheatpaste Posters & Full Slap Kit. Stake the 721 NFT for $MONA yield. You’ll be sent an email upon purchase guiding you on how to process all shipment details. You’ll also be sent a 721 stackable version of the NFT upon placing the IRL order.',
        'Exclusive digital art piece from the HimeX realm.',
        'A surprise NYC Streetwear runway NFT. Stake the 721 NFT for $MONA yield.',
        'To pay homage to the often overlooked lionhearts within the web3 community— the devs— we are introducing Web3 Wizards; an ongoing series of on-chain NFT web3 dev characterisations; spotlighting new devs every issue, all designed and minted in-house by DIGITALAX. For this edition of Web3 Wizards we are spotlighting the devs, engineers and teams that are developing all that is necessary for The Merge to become a reality and take web3 to the next level. The Merge Masters.',
        'To pay homage to the often overlooked lionhearts within the web3 community— the devs— we are introducing Web3 Wizards; an ongoing series of on-chain NFT web3 dev characterisations; spotlighting new devs every issue, all designed and minted in-house by DIGITALAX. For this edition of Web3 Wizards we are spotlighting the devs, engineers and teams that are developing all that is necessary for The Merge to become a reality and take web3 to the next level. The Merge Masters.',
        'To pay homage to the often overlooked lionhearts within the web3 community— the devs— we are introducing Web3 Wizards; an ongoing series of on-chain NFT web3 dev characterisations; spotlighting new devs every issue, all designed and minted in-house by DIGITALAX. For this edition of Web3 Wizards we are spotlighting the devs, engineers and teams that are developing all that is necessary for The Merge to become a reality and take web3 to the next level. The Merge Masters.',
        'To pay homage to the often overlooked lionhearts within the web3 community— the devs— we are introducing Web3 Wizards; an ongoing series of on-chain NFT web3 dev characterisations; spotlighting new devs every issue, all designed and minted in-house by DIGITALAX. For this edition of Web3 Wizards we are spotlighting the devs, engineers and teams that are developing all that is necessary for The Merge to become a reality and take web3 to the next level. The Merge Masters.',
      ],
...
export const info = [
  {
    image: '/images/nft/14/Artboard 0.png',
    id: 'FOURTEEN',
    title: 'DIGIFIZZY',
  },
  {
    image: '/images/nft/13/home.png',
    id: 'THIRTEEN',
    title: 'DIGIFIZZY',
  },
  {
