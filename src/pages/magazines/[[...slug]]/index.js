...
const MagazinePages = () => {
  ...
  if (viewMethod === 'magazineview') {
    if (width > 768) {
      return (
        <MagazineViewer issueId={issueId} initPage={currentPage} onSwitchViewer={switchViewer} />
      );
    }
    return (
      <MagazineMobile issueId={issueId} initPage={currentPage} onSwitchViewer={switchViewer} />
    );
  }
